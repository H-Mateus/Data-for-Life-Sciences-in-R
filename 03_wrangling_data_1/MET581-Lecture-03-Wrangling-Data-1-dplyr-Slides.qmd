...
We will keep repairing this same cohort in every session from here to Exploratory
Data Analysis. By the end you will have built a cleaned dataset, and a record of
every change you made to it — which is exactly what the report asks for.
...
write_rds(cohort, "my_work/cohort_after_s4.rds")
```
...
Next session: joins and reshaping.
