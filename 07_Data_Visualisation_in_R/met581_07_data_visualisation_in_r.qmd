...
-   If you want to go further, there is an **optional** section on the course
    ...
    *wiring an assistant into your R session*](https://h-mateus.github.io/Data-for-Life-Sciences-in-R/00_llm_use/using_ai_assistants.html)
...
-   These slides can be found on the website [here](https://h-mateus.github.io/Data-for-Life-Sciences-in-R/):
