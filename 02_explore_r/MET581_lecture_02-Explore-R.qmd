...
1.    Use the base R function `read.table()` to import the [pheno.txt](https://github.com/H-Mateus/Data-for-Life-Sciences-in-R/blob/main/data/pheno.txt) file. Then repeat this with `read_tsv()` from Readr, what is the difference? 
